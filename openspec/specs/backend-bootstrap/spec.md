# Capability: Backend Bootstrap

## Purpose

Defines the initial structure of the `apps/api` workspace: NestJS application running on Fastify, global route prefix, configurable port, minimal root module, TypeScript configuration with decorator support, Jest test setup, and workspace scripts.
